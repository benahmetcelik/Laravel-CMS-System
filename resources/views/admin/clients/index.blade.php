        ...
        <div class="panel panel-inverse">
            ...
            @foreach($clients as $client)
                    ...
                    <tr class="gradeU" id="post_{!! $client->id !!}">
                        ...
                        <td class="with-img"><img src="{!! asset('/web/clients/'.$client->img_url) !!}" class="img-rounded height-30" alt=""/></td>
                        <td><a href="{!! route('admin.clients.edit',$client->id) !!}">{!! $client->title !!} - <small>Düzenlemek için tıklayınız</small></a></td>
                        <td>
...
@section('script')
    ...
    <script>
        ...
        $(document.body).on('click',changeStatusButton,function () {
            ...
            $.ajax({
                url:"{!! route('admin.clients.statusUpdate') !!}",
                type: 'POST',
                data : {
                ...
                success:function (response){
                    ...
                    if (response == true){
                        admin_respones('Başarıyla Güncellendi','Marka Güncelleme İşlemi Başarılı Oldu','success');
                    }else{
                        admin_respones('Başarısız Oldu','Marka Güncelleme İşlemi Başarısız Oldu','error');
                    }
