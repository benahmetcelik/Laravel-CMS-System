            ...
            <div class="col-xl-12">
                ...
                <div class="panel panel-inverse m-b-0" data-sortable-id="form-plugins-15">
                    ...
                    <div class="panel-body p-0">
                        <form action="{!! route('admin.service.update',$gallery->id) !!}" method="post" enctype="multipart/form-data">
                            @csrf
                            ...
                            <div class="form-group row m-b-10">
                                ...
                                <div class="col-md-9">
                                    ...
                                    <img src="{!! asset('web/services/'.$gallery->img_url) !!}" alt="" class="img-thumbnail" style="width: 100px">
