            ...
            <div class="col-xl-12">
                ...
                <div class="panel panel-inverse m-b-0">
                    <div class="panel-heading">
                        <h4 class="panel-title">İçeriğinizi Paylaşın</h4>
                    ...
                    <div class="panel-body p-0">
                        <form action="{!! route('admin.posts.update',$post->id) !!}" method="post" enctype="multipart/form-data">
                            ...
                            <div class="form-group row py-3 m-b-15">
                                <label class="col-form-label col-md-3">Yazınızın Başlığı</label>
                                <div class="col-md-9">
                                    <input type="text" name="title" id="title" class="form-control m-b-5"
                                           placeholder="Yazınızn Başlığı" value="{!! $post->title !!}" required/>
                                </div>
                            </div>
                            <div class="form-group row m-b-10">
                                ...
                                <div class="col-md-9">
                                    ...
                                    <img src="{!! asset('web/posts/'.$post->img_url) !!}" alt="" class="img-thumbnail" style="width: 100px">
                            ...
                            <div class="form-group row m-b-15">
                                <label class="col-form-label col-md-3">Yazınızın Linki</label>
                                <div class="col-md-9">
                                    <input type="text" class="form-control m-b-5" name="slug" id="slug"
                                           placeholder="Yazınızn Başlığı" value="{!! $post->slug !!}"/>
                                    <small class="f-s-12 text-grey-darker">Karışıklık Olmaması İçin Lütfen
                                        Dokunmayınız</small>
                                </div>
                            </div>
                            ...
                            <div class="form-group row m-b-10 align-items-center">
                                ...
                                <div class="col-md-9">
                                    ...
                                    <select class="select2 form-control" id="parent_categories" name="category_id"
                                            required="true">
                            ...
                            <textarea class="summernote" name="content" placeholder="Yazmaya başlayın...">{!! $post->content !!}</textarea>

                            <div class="form-group row py-3 m-b-10">

                                <label class="col-form-label col-md-3">Yazınızı Paylaşın</label>
                                <div class="col-md-9">
                                    <button  class="form-control btn btn-success m-b-5" style="color: white"  id="sharePost">Paylaş</button>
                                </div>
