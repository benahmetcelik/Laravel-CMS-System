                    ...
                    <div class="panel-body p-0">
                        <form action="{!! route('admin.faqs.update',$faq->id) !!}" method="post" enctype="multipart/form-data">
                            ...
                            <div class="form-group row py-3 m-b-15">
                                ...
                                <div class="col-md-9">
                                    <input type="text" name="title" id="title" class="form-control m-b-5" value="{!! $faq->title!!}"
                            ...
                            <div class="form-group row m-b-10 align-items-center">
                                ...
                                <div class="col-md-9">
                                    ...
                                    <select class="select2 form-control" id="status" name="status"
                                            ...
                                            <option value="1" {!! ($faq->status == 1) ? 'selected' : '' !!}>Göster</option>

                                            <option value="0" {!! ($faq->status == 0) ? 'selected' : '' !!}>Gösterme</option>
                                    </select>
                                </div>
