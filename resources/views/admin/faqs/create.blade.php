...
@section('content')
    ...
    <div id="content" class="content">
        ...
        <!-- end breadcrumb -->
        <!-- begin page-header -->
        <h1 class="page-header">Soru Paylaşın <small> Karışma olmaması için lütfen url ile oynamayın.</small>
        </h1>
        <!-- end page-header -->
        <!-- begin row -->
        <div class="row">
            ...
            <div class="col-xl-12">
                ...
                <div class="panel panel-inverse m-b-0" data-sortable-id="form-plugins-15">
                    <div class="panel-heading">
                        <h4 class="panel-title">Soru Paylaşın</h4>
                    ...
                    <div class="panel-body p-0">
                        <form action="{!! route('admin.faqs.store') !!}" method="post" enctype="multipart/form-data">
                            ...
                            <div class="form-group row py-3 m-b-15">
                                <label class="col-form-label col-md-3">Marka Başlığı</label>
                                <div class="col-md-9">
                            ...
                            <div class="form-group row py-3 m-b-10">
                                ...
                                <label class="col-form-label col-md-3">Soruyu Kaydet</label>
                                <div class="col-md-9">
