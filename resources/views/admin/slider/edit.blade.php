                    ...
                    <div class="panel-body p-0">
                        <form action="{!! route('admin.slider.update',$slider->id) !!}" method="post" enctype="multipart/form-data">
                            ...
                            <div class="form-group row py-3 m-b-15">
                                ...
                                <div class="col-md-9">
                                    <input type="text" name="title" id="title" class="form-control m-b-5" value="{!! $slider->title!!}"
                            ...
                            <div class="form-group row py-3 m-b-15">
                                <label class="col-form-label col-md-3">Slider İçeriği</label>
                                <div class="col-md-9">
                                    <input type="text" name="content" id="content" class="form-control m-b-5" value="{!! $slider->content!!}"
                            ...
                            <div class="form-group row m-b-10">
                                ...
                                <div class="col-md-9">
                                    ...
                                    <img src="{!! asset('web/sliders/'.$slider->img_url) !!}" alt="" class="img-thumbnail" style="width: 100px">
                            ...
                            <div class="form-group row m-b-10 align-items-center">
                                ...
                                <div class="col-md-9">
                                    ...
                                    <select class="select2 form-control" id="status" name="status"
                                            ...
                                            <option value="1" {!! ($slider->status == 1) ? 'selected' : '' !!}>Göster</option>

                                            <option value="0" {!! ($slider->status == 0) ? 'selected' : '' !!}>Gösterme</option>
                                    </select>
                                </div>
