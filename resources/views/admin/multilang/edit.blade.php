            ...
            <div class="col-xl-12">
                ...
                <div class="panel panel-inverse m-b-0" data-sortable-id="form-plugins-15">
                    ...
                    <div class="panel-body p-0">
                        <form action="{!! route('admin.multilang.update',$lang->id) !!}" method="post" enctype="multipart/form-data">
                            @csrf
                            <div class="form-group row py-3 m-b-15">
                                ...
                                <div class="col-md-9">
                                    <input type="text" name="lang_name" id="lang_name" class="form-control m-b-5"
                                           placeholder="Dil Başlığı" value="{!! $lang->lang_name !!}"/>
                                </div>
                            </div>
                            <div class="form-group row py-3 m-b-15">
                                ...
                                <div class="col-md-9">
                                    <input type="text" name="lang_short" id="lang_short" class="form-control m-b-5"
                                           placeholder="Dil Kısaltması" value="{!! $lang->lang_short !!}"/>
                                </div>
                            </div>
                                ...
                                <div class="col-md-9">
                                    <div class="input-group">
                                        <div class="custom-file">
                                            ...
                                            <img src="{!! asset('/web/langs/'.$lang->lang_flag) !!}" class="img-thumbnail" style="width: 100px" alt="">
                                        </div>
                            ...
                            <div class="form-group row m-b-10 align-items-center">
                                ...
                                <div class="col-md-9">
                                    ...
                                    <select class="select2 form-control" id="status" name="status"
                                            required="true">
                                        <option value="0"  {!! ($lang->status == 0) ? 'selected' : '' !!}>Kapalı</option>
                                        <option value="1" {!! ($lang->status == 1) ? 'selected' : '' !!}>Aktif</option>
                                    </select>
                                </div>
                            ...
                            <div class="form-group row m-b-10 align-items-center">
                                <label class="col-md-3 col-form-label">Varsayılan</label>
                                <div class="col-md-9">
                                    <select class="select2 form-control" id="status" name="default_lang"
                                            required="true">
@if($lang->default_lang != 1)

                                            <option value="0"  {!! ($lang->default_lang == 0) ? 'selected' : '' !!}>Kapalı</option>
@endif
    <option value="1" {!! ($lang->default_lang == 1) ? 'selected' : '' !!}>Aktif</option>
                            ...
                            <div class="form-group row py-3 m-b-10">
                                ...
                                <label class="col-form-label col-md-3">Dil Kaydet</label>
                                <div class="col-md-9">
