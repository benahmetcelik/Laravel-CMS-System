                    ...
                    <div class="panel-body p-0">
                        <form action="{!! route('admin.menus.update',$menu->id) !!}" method="post" enctype="multipart/form-data">
                            ...
                            <div class="form-group row py-3 m-b-15">
                                <label class="col-form-label col-md-3">Menü Başlığı</label>
                                <div class="col-md-9">
                                    <input type="text" name="name" id="name" class="form-control m-b-5" value="{!! $menu->name !!}"
                                           placeholder="Yazınızn Başlığı" required/>
                                </div>
                            </div>
                            ...
                            <div class="form-group row m-b-10 align-items-center">
                                <label class="col-md-3 col-form-label">Yerleşimi Seçini</label>
                                <div class="col-md-9">

                                    <select class="select2 form-control" id="parent_categories" name="layout"
                                            required="true">
                                        <option value="0" {!! ($menu->layout == 0) ? 'selected' : '' !!} >Header</option>
                                        <option value="1" {!! ($menu->layout == 1) ? 'selected' : '' !!}>Sidebar</option>
                                        <option value="2" {!! ($menu->layout == 2) ? 'selected' : '' !!}>Footer</option>
                                        <option value="3" {!! ($menu->layout == 3) ? 'selected' : '' !!}>En Alt Menü</option>
                            ...
                            <div class="form-group row m-b-10 align-items-center">
                                ...
                                <div class="col-md-9">
                                    ...
                                    <select class="select2 form-control" id="status" name="status"
                                            required="true">
                                        <option value="0"  {!! ($menu->status == 0) ? 'selected' : '' !!}>Gösterme</option>
                                        <option value="1" {!! ($menu->status == 1) ? 'selected' : '' !!}>Göster</option>
                                    </select>
                                </div>
                            </div>
                            ...
                            <div class="form-group row py-3 m-b-10">
                                ...
                                <label class="col-form-label col-md-3">Menüyü Kaydet</label>
                                <div class="col-md-9">
