...
@section('content')
    ...
    <div id="content" class="content">
        ...
        <!-- end breadcrumb -->
        <!-- begin page-header -->
        <h1 class="page-header">Galeri Paylaşın <small> Karışma olmaması için lütfen url ile oynamayın.</small>
        </h1>
        <!-- end page-header -->
        <!-- begin row -->
        <div class="row">
                    ...
                    <div class="panel-body p-0">
                        <form action="{!! route('admin.gallery.store') !!}" method="post" enctype="multipart/form-data">
                            ...
                            <div class="form-group row py-3 m-b-15">
                                <label class="col-form-label col-md-3">Galeri Başlığı</label>
                                <div class="col-md-9">
                            ...
                            <div class="form-group row py-3 m-b-15">
                                ...
                                <div class="col-md-9">
                                    <input type="text" name="gallery_url" id="gallery_url" class="form-control m-b-5"
                                           placeholder="Galeri Linki" required/>
                                </div>
                            </div>
