                    ...
                    <div class="panel-body p-0">
                        <form action="{!! route('admin.gallery.update',$gallery->id) !!}" method="post" enctype="multipart/form-data">
                            ...
                            <div class="form-group row py-3 m-b-15">
                                <label class="col-form-label col-md-3">Slider Başlığı</label>
                                <div class="col-md-9">
                                    <input type="text" name="title" id="title" class="form-control m-b-5" value="{!! $gallery->title!!}"
                                           placeholder="Yazınızn Başlığı" required/>
                                </div>
                            </div>

                            <div class="form-group row py-3 m-b-15">
                                <label class="col-form-label col-md-3">Galeri Linki</label>
                                <div class="col-md-9">
                                    <input type="text" name="gallery_url" id="gallery_url" class="form-control m-b-5"
                                           placeholder="Galeri Linki" value="{!! $gallery->gallery_url!!}" required/>
                                </div>
                            </div>
                            ...
                            <div class="form-group row m-b-10">
                                ...
                                <div class="col-md-9">
                                    ...
                                    <img src="{!! asset('web/gallery/'.$gallery->img_url) !!}" alt="" class="img-thumbnail" style="width: 100px">
                            ...
                            <div class="form-group row m-b-10 align-items-center">
                                ...
                                <div class="col-md-9">
                                    ...
                                    <select class="select2 form-control" id="status" name="status"
                                            ...
                                            <option value="1" {!! ($gallery->status == 1) ? 'selected' : '' !!}>Göster</option>

                                            <option value="0" {!! ($gallery->status == 0) ? 'selected' : '' !!}>Gösterme</option>
                                    </select>
                                </div>
