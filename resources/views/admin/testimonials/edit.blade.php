...
@section('content')
    ...
    <div id="content" class="content">
        ...
        <!-- end breadcrumb -->
        <!-- begin page-header -->
        <h1 class="page-header">Yorum Paylaşın <small> Karışma olmaması için lütfen url ile oynamayın.</small>
        </h1>
        <!-- end page-header -->
        <!-- begin row -->
        <div class="row">
            ...
            <div class="col-xl-12">
                ...
                <div class="panel panel-inverse m-b-0" data-sortable-id="form-plugins-15">
                    <div class="panel-heading">
                        <h4 class="panel-title">Yorum Paylaşın</h4>
                    ...
                    <div class="panel-body p-0">
                        <form action="{!! route('admin.testimonials.update',$testimonial->id) !!}" method="post" enctype="multipart/form-data">
                            ...
                            <div class="form-group row py-3 m-b-15">
                                <label class="col-form-label col-md-3">Müşteri Adı</label>
                                <div class="col-md-9">
                                    <input type="text" name="name" id="name" class="form-control m-b-5"
                                           placeholder="Yazınızn Başlığı" value="{!! $testimonial->name !!}" required/>
                                </div>
                            </div>
                            <div class="form-group row py-3 m-b-15">
                                <label class="col-form-label col-md-3">Yorum</label>
                                <div class="col-md-9">
                                    <textarea name="description" id="description" class="form-control-plaintext">{!! $testimonial->description !!}</textarea>

                                </div>
                            </div>
                            <div class="form-group row py-3 m-b-15">
                                <label class="col-form-label col-md-3">Sektör</label>
                                <div class="col-md-9">
                                    <input type="text" name="sector" id="sector" class="form-control m-b-5"
                                           placeholder="Yazınızn Başlığı" value="{!! $testimonial->sector !!}" required/>
                                </div>
                            </div>
                            <div class="form-group row m-b-10">
                                <label class="col-form-label col-md-3">Müşteri Resim</label>
                                <div class="col-md-9">
                                    <img src="{!! asset('/web/testimonials/'.$testimonial->img_url) !!}" alt="" class="img-circle img-thumbnail" width="100">
                            ...
                            <div class="form-group row m-b-10 align-items-center">
                                ...
                                <div class="col-md-9">
                                    ...
                                    <select class="select2 form-control" id="status" name="status"
                                        ...
                                        <option value="1" {!! ($testimonial->status == 1) ? 'selected' : '' !!}>Göster</option>

                                        <option value="0" {!! ($testimonial->status == 0) ? 'selected' : '' !!}>Gösterme</option>
                            ...
                            <div class="form-group row py-3 m-b-10">
                                ...
                                <label class="col-form-label col-md-3">Yorumu Kaydet</label>
                                <div class="col-md-9">
